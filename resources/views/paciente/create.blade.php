                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('paciente.store') }}">
                        ...
                        <div class="form-group{{ $errors->has('materno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="materno" type="text" class="form-control" name="materno" value="{{ old('materno') }}">
                        ...
                        <div class="form-group{{ $errors->has('carnet') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="carnet" type="text" class="form-control" name="carnet" value="{{ old('carnet') }}" required>
